...
class RegEx {
    public:
         ...
         *    subject last passed to Search or SearchAt, but restarts the search after the last
         * match. Subsequent calls to SearchAgain() will find all matches in the subject.
        ...
        bool MatchString(
            UtlString *matched, /**< string to append the match to -
        ...
        bool BeforeMatchString(
            UtlString *before /**< string to append to -
                               * may be NULL, in which case no string is returned,
                               * but the return code still indicates whether or not
        ...
        bool
            AfterMatchString(UtlString *before /**< string to append to -
                                                * may be NULL, in which case no string is returned,
                                                * but the return code still indicates whether or not
